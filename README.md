...
| [API.md](API.md) | REST API reference (70 endpoints across 9 categories) |
...
Giulia can analyze herself. The report below was generated by pointing Giulia's 70 API endpoints at her own codebase — the same analysis available for any Elixir project.
...
- **Build**: 140
- **Tests**: 1,707 tests
- **API**: 70 self-describing endpoints across 9 categories (discovery, index, knowledge, intelligence, runtime, search, transaction, approval, monitor)
